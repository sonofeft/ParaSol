...
# -*- coding: utf-8 -*-
#
# ParaSol documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'parasol','_version.py')
...
latex_documents = [
  (master_doc, 'ParaSol.tex', u'ParaSol Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'ParaSol Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ParaSol', u'ParaSol Documentation',
